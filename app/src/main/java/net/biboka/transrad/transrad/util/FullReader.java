...
public class FullReader {
    ...
    private ArrayList<ArrayList<String>> tmp_content;
    private ArrayList<ArrayList<ArrayList<String>>> content;
    ...
    public FullReader(Context context) {
    ...
    public void getTable() {
        ...
        for (int k=1;k<lastDayOfMonth;k++) {
            ...
            for (int i = 1; i < arr.length; i++) {
                ...
                for (int j = 0; j < kocka.length; j++) {
                    if (kocka[j] == null) {
                        tmp.add("");
                    } else {
                        tmp.add(kocka[j]);
                    }
                    if (j == 13 && kocka.length == 14) {
                        tmp.add("");
                    }
                }
                tmp_content.add(tmp);
        ...
        Log.d("FULL READER",header.toString());
        Log.d("FULL READER",content.toString());
        alreadyRead = true;
    }
    ...
    public ArrayList<ArrayList<ArrayList<String>>> getContent() {
